...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final heroTag = 'product-${product.id}-cover';
    ...
    // ✅ جديد: لفّ الكارد كله بـ InkWell علشان يسمع الضغط
    return InkWell(
      onTap: onTap, // لو null مش هيعمل حاجة
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Hero(tag: heroTag, child: imageWidget), // ⬅️ التغيير هنا
                Positioned(
                  top: 0,
                  right: 0,
                  child: Container(
